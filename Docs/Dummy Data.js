...
const User = [
  { name: 'Islam Sanad',
    ...
    username: 'isanad',
    password: 'whatsup123',
    email: 'islam.sanad@student.guc.edu.eg',
    dateofregistration: '',
    phonenumber: '1234',
    usertype: 'Partner',
    location: 'Shrouk , Cairo' },
  { name: 'Ismail Aboulela',
    id: '40-15364',
    username: 'ismailaboulela',
    password: 'sup123',
    email: 'ismail.aboulela@student.guc.edu.eg',
    dateofregistration: '',
    phonenumber: '5678',
    usertype: 'Partner',
    location: 'GUC , Cairo' },
  { name: 'Gomana El-Shimy',
    id: '40-1712',
    username: 'gomanaelshimy',
    password: 'gello2222',
    email: 'gomanaelshimy@student.guc.edu.eg',
    dateofregistration: '',
    phonenumber: '33312',
    usertype: 'Partner',
  ...
  { name: 'Omar Yasser',
    ...
    username: 'omaryasser',
    password: 'hiyo123123',
    email: 'omaryasser@student.guc.edu.eg',
    dateofregistration: '',
    phonenumber: '1342',
    usertype: 'Admin',
  ...
  { name: 'Clara Kamel',
    ...
    username: 'clarakamel',
    password: 'heeey33312',
    email: 'clarakamel@student.guc.edu.eg',
    dateofregistration: '',
    phonenumber: '8979',
    usertype: 'Admin',
  ...
  { name: 'Hania Ghannam',
    id: '37-3641',
    username: 'haniaghannam',
    password: 'hii123123',
    email: 'haniaghannam@student.guc.edu.eg',
    dateofregistration: '',
    phonenumber: '432312',
    usertype: 'Admin',
    location: '90st, Cairo' },
  ...
  { name: 'Karim El-Mahdy',
    id: '40-2564',
    username: 'karimelmahdy',
    password: 'eyyy123123',
    email: 'karimelmahdy@student.guc.edu.eg',
    dateofregistration: '',
    phonenumber: '585858',
    usertype: 'Candidate',
    location: 'Rehab, Cairo' },
  { name: 'Hagar Abdelnabi',
    id: '40-14905',
    username: 'hagarabdelnabi',
    password: 'ayy45645',
    email: 'hagarabdelnabi@student.guc.edu.eg',
    dateofregistration: '',
    phonenumber: '777123',
    usertype: 'Candidate',
    location: 'Abbas, Cairo' },
  { name: 'Lobna El-Badrawy',
    id: '40-15177',
    username: 'lobnaelbadrawy',
    password: 'girlz2313',
    email: 'lobnaelbadrawy@student.guc.edu.eg',
    dateofregistration: '',
    phonenumber: '451123',
    usertype: 'Candidate',
